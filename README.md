...
This is the repository of source code and site content for SOC 4650/5650's website. The site is hosted by [GitHub.com](http://github.com) and powered by the `R` package [`bookdown`](https://bookdown.org), an open-source web publishing tool.
