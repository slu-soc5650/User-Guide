...
Both the Syllabus (which sets out course policies) and the Reading List (which is a week-by-week rundown of course activities, readings, and assignments) are already available on GitHub in the [Core-Documents](https://github.com/slu-soc5050/Core-Documents) repository (a repository is GitHub's name for a top-level directory). If you bring specific questions to the first class, it makes for a more informed course overview!

## Get Access to Books and Readings
### Books
